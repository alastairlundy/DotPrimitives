/*
    ...
    Some comments in this file have removed redundant phrasing or wording. Some comments have clarified that some of the kinds are mainly used by the US.
...
public enum PaperKind
{
    ...
    Custom = 0,
    /// <summary>
    /// US Letter paper (8.5 in. by 11 in.).
    /// </summary>
    Letter = 1,
    /// <summary>
    /// US Letter small paper (8.5 in. by 11 in.).
    /// </summary>
    LetterSmall = 2,
    /// <summary>
    ...
    /// <summary>
    /// #5 rotated envelope (220 mm by 110 mm). Requires Windows NT 4.0 or later.
    /// </summary>
